...
from chainer.functions.evaluation import accuracy, binary_accuracy
...
class Classifier(BaseForwardModel):
    ...
    def __init__(self, predictor,
                 ...
                 lossfun=sigmoid_cross_entropy.sigmoid_cross_entropy,
                 accfun=None, metrics_fun=binary_accuracy.binary_accuracy, # metrics_fun=accuracy.accuracy,
    ...
    def predict(
            self, data, batchsize=16, converter=concat_examples,
            retain_inputs=False, preprocess_fn=None, postprocess_fn=None): #_argmax):
